...
export function showImageEditorView() {
    ...
    imageEditorDiv.innerHTML = /*html*/ `
        <div class="text-black flex flex-col gap-5 bg-zinc-200 min-h-dvh px-4 py-8">
            ...
            <div id="editing-area" class="grid grid-cols-5 grid-rows-5 gap-4 mx-auto sm:max-w-5xl h-[40vh]">
                ...
                <div id="preview-img" class="flex justify-center items-center min-w-0 min-h-0 overflow-hidden col-span-3 col-start-2 row-span-4 row-start-2 border rounded-xl border-zinc-400">
                ...
                <div id="feed" class="overflow-auto min-w-0 min-h-0 flex flex-col gap-5 p-5 col-span-1 col-start-5 row-span-5 row-start-1 border rounded-xl border-zinc-400">
